        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
          {getVisible().map((t, i) => (
            ...
            >
              ...
              <div className="relative h-44 bg-gradient-to-br from-[#0A1A2E] to-[#0D1528] flex">
                <div className="flex-1 flex items-center justify-center border-r border-white/10">
                  <div className="text-center">
                    <div className="w-12 h-12 rounded-full bg-white/5 mx-auto mb-1 flex items-center justify-center text-xl">
                      📸
                    </div>
                ...
                <div className="flex-1 flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-12 h-12 rounded-full bg-[#00C2FF]/10 mx-auto mb-1 flex items-center justify-center text-xl">
                      💪
                    </div>
                ...
                {/* Result badge */}
                <div className="absolute top-3 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full bg-gradient-to-r from-[#00C2FF] to-[#00E5A0] text-[#0A0F1E] text-xs font-black whitespace-nowrap">
                  {t.result}
                </div>
              </div>
              ...
              <div className="p-4">
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <span className="text-xs text-[#00C2FF] bg-[#00C2FF]/10 px-2 py-0.5 rounded-full">
                    {t.duration}
                  </span>
                </div>
