  ...
  return (
    <section id="about" className="py-20 px-5" style={{ background: "#0d1a2e" }}>
      <div className="max-w-3xl mx-auto">
        ...
        >
          At <strong style={{ color: "#ffffff" }}>Fix Your Body,</strong> we believe real fitness means building confidence, not dependency. Our coaching system is built to make you trainer-independent: equipped with the knowledge, technique, and discipline to work out effectively on your own terms.
        </p>
        <p
          className="mb-4"
          style={{ fontSize: "15px", color: "rgba(255,255,255,0.65)", lineHeight: 1.80 }}
        ...
        <p
          ...
          style={{ fontSize: "15px", color: "rgba(255,255,255,0.65)", lineHeight: 1.80 }}
        >
          Our team brings experience from leading fitness organisations like <strong style={{ color: "#ffffff" }}>Fittr</strong> and <strong style={{ color: "#ffffff" }}>Team Aminder</strong>, combining proven coaching methods with evidence-based practices to deliver lasting transformations.
        </p>
